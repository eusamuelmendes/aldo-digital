...
const CATEGORIES: Array<{
...
}> = [
  {
    ...
    products: [
      ...
      { name: "Peito de Frango (filé)", priceCents: 1300, prepStation: "CHURRASQUEIRA", imageUrl: "/products/brasa-peito-de-frango-file.jpg" },
      ...
      { name: "Carne de Sol", priceCents: 1750, prepStation: "CHURRASQUEIRA", imageUrl: "/products/brasa-carne-de-sol.jpg" },
  ...
  },
  {
    ...
    sortOrder: 5,
    products: [
      { name: "Batata Frita c/ Queijo e Bacon", priceCents: 2700, prepStation: "COZINHA", imageUrl: "/products/porcoes-batata-frita-c-queijo-e-bacon.jpg" },
      { name: "Batata Frita c/ Queijo", priceCents: 2000, prepStation: "COZINHA", imageUrl: "/products/porcoes-batata-frita-c-queijo.jpg" },
      { name: "Batata Frita (meia)", priceCents: 1800, prepStation: "COZINHA", imageUrl: "/products/porcoes-batata-frita-meia.jpg" },
      {
        name: "Picanha (porção)",
        description: "500g, mandioca, cebola frita e salada",
        priceCents: 5200,
        prepStation: "CHURRASQUEIRA",
        imageUrl: "/products/porcoes-picanha-porcao.jpg",
      },
      {
        name: "Frango (porção)",
        ...
        priceCents: 3000,
        prepStation: "CHURRASQUEIRA",
        imageUrl: "/products/porcoes-frango-porcao.jpg",
      },
      {
        ...
        priceCents: 2500,
        prepStation: "CHURRASQUEIRA",
        imageUrl: "/products/porcoes-calabresa-porcao.jpg",
      },
      { name: "Frango à Passarinho (1kg)", priceCents: 2500, prepStation: "COZINHA", imageUrl: "/products/porcoes-frango-a-passarinho-1kg.jpg" },
      { name: "Salame com Ovo de Codorna", priceCents: 2000, prepStation: "COZINHA", imageUrl: "/products/porcoes-salame-com-ovo-de-codorna.jpg" },
      {
        name: "Contra-Filé (porção)",
        description: "500g, mandioca, cebola frita e salada",
        priceCents: 4000,
        prepStation: "CHURRASQUEIRA",
        imageUrl: "/products/porcoes-contra-file-porcao.jpg",
      },
      { name: "Mandioca Frita (800g)", priceCents: 1200, prepStation: "COZINHA", imageUrl: "/products/porcoes-mandioca-frita-800g.jpg" },
      { name: "Meia Porção Mandioca", priceCents: 800, prepStation: "COZINHA", imageUrl: "/products/porcoes-meia-porcao-mandioca.jpg" },
      { name: "Picanha com Fritas", priceCents: 7000, prepStation: "CHURRASQUEIRA", imageUrl: "/products/porcoes-picanha-com-fritas.jpg" },
      { name: "Contra-Filé com Mandioca Frita", priceCents: 5000, prepStation: "CHURRASQUEIRA", imageUrl: "/products/porcoes-contra-file-com-mandioca-frita.jpg" },
      { name: "Tábua de Frios", priceCents: 4000, prepStation: "COZINHA", imageUrl: "/products/porcoes-tabua-de-frios.jpg" },
      { name: "Tábua de Frios (meia)", priceCents: 2500, prepStation: "COZINHA", imageUrl: "/products/porcoes-tabua-de-frios-meia.jpg" },
    ],
  },
  {
    slug: "bebidas",
    ...
    products: [
      ...
      { name: "Budweiser 600ml", priceCents: 1100, prepStation: "BAR", imageUrl: "/products/bebidas-budweiser-600ml.jpg" },
      { name: "Bohemia 600ml", priceCents: 1100, prepStation: "BAR", imageUrl: "/products/bebidas-bohemia-600ml.jpg" },
      { name: "Cerveja Eisenbahn 600ml", priceCents: 1100, prepStation: "BAR", imageUrl: "/products/bebidas-cerveja-eisenbahn-600ml.jpg" },
      { name: "Cerveja Antarctica Original", priceCents: 1100, prepStation: "BAR", imageUrl: "/products/bebidas-cerveja-antarctica-original.jpg" },
      { name: "Brahma 600ml", priceCents: 900, prepStation: "BAR", imageUrl: "/products/bebidas-brahma-600ml.jpg" },
      { name: "Cerveja Itaipava Premium", priceCents: 900, prepStation: "BAR", imageUrl: "/products/bebidas-cerveja-itaipava-premium.jpg" },
      { name: "Skol 600ml", priceCents: 800, prepStation: "BAR", imageUrl: "/products/bebidas-skol-600ml.jpg" },
      { name: "Crystal 600ml", priceCents: 700, prepStation: "BAR", imageUrl: "/products/bebidas-crystal-600ml.jpg" },
      { name: "Cerveja Itaipava", priceCents: 700, prepStation: "BAR", imageUrl: "/products/bebidas-cerveja-itaipava.jpg" },
      { name: "Crystal Sem Álcool", priceCents: 600, prepStation: "BAR", imageUrl: "/products/bebidas-crystal-sem-alcool.jpg" },
      { name: "Itaipava Sem Álcool", priceCents: 600, prepStation: "BAR", imageUrl: "/products/bebidas-itaipava-sem-alcool.jpg" },
      { name: "Brahma Long Neck S/ Álcool", priceCents: 600, prepStation: "BAR", imageUrl: "/products/bebidas-brahma-long-neck-s-alcool.jpg" },
      { name: "Crystal Lata", priceCents: 300, prepStation: "BAR", imageUrl: "/products/bebidas-crystal-lata.jpg" },
      { name: "Skol Lata", priceCents: 300, prepStation: "BAR", imageUrl: "/products/bebidas-skol-lata.jpg" },
      { name: "Brahma Lata (350ml)", priceCents: 300, prepStation: "BAR", imageUrl: "/products/bebidas-brahma-lata-350ml.jpg" },
      { name: "Itaipava Lata (350ml)", priceCents: 300, prepStation: "BAR", imageUrl: "/products/bebidas-itaipava-lata-350ml.jpg" },
      { name: "Skol Palito (269ml)", priceCents: 300, prepStation: "BAR", imageUrl: "/products/bebidas-skol-palito-269ml.jpg" },
      { name: "Brahma Palito (269ml)", priceCents: 300, prepStation: "BAR", imageUrl: "/products/bebidas-brahma-palito-269ml.jpg" },
      { name: "Copo Cosmel", priceCents: 300, prepStation: "BAR", imageUrl: "/products/bebidas-copo-cosmel.jpg" },
